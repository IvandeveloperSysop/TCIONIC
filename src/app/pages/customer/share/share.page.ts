  ...
  async shareAppWhatsapp(){
    const actionSheet = await this.actionSheetController.create({
      ...
      buttons: [{
        ...
        icon: 'logo-whatsapp',
        handler: () => {
          window.location.href ='https://api.whatsapp.com/send?&text=!Hey!%20reg%C3%ADstrate%20para%20ganar%20Hieleras%20y%20Tarjetas%20Virtuales,%20revisa%20la%20informaci%C3%B3n%20en%20este%20enlace%20:D%20%20%20https://somostopochico.com/refer/' + this.nickName;
        }
      }, {
